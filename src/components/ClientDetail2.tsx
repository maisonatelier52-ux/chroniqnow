    ...
    <>
      <Head>
        <link
          rel="preload"
          as="image"
          href="/images/wanda-vazquez-looking-at-mirror.avif"
          type="image/avif"
        />
      </Head>
        ...
        <div className="space-y-10">
          ...
          <section>
            ...
            <p className="text-base leading-relaxed mb-4">
              ...
              <span className="text-[#2077B6]">August 2022</span> on seven
              federal counts, including{" "}
              <span className="text-[#2077B6]">
                conspiracy to commit bribery
              </span>
              , honest services wire fraud, and violations of the Federal
            ...
            <p className="text-base leading-relaxed">
              ...
              senior Department of Justice officials, defense counsel, and
              federal prosecutors. Shortly thereafter, a plea agreement was
          ...
          <section>
            ...
            <p className="text-base leading-relaxed mb-4">
              Court documents and admissions outline the following conduct
              during the <span className="text-[#2077B6]">March–June 2020</span>{" "}
              window, coinciding with the early months of the
              <span className="text-[#2077B6]"> global COVID-19 pandemic</span>:
            </p>

            <p className="text-base leading-relaxed mb-2">
              • <span className="text-[#2077B6]">Wanda Vázquez Garced</span>,
              then governor and candidate in the
              <span className="text-[#2077B6]">
                &nbsp;New Progressive Party (PNP)
              </span>{" "}
              primary, is expected to admit she knowingly accepted a promise of
              a political donation from a{" "}
              <span className="text-[#2077B6]">foreign national</span>,
              violating <span className="text-[#2077B6]">federal law</span>. The
              amount exceeded $2,000 but remained under $25,000 [source: Court
              Filing Summary].
            </p>

            <p className="text-base leading-relaxed mb-2">
              • <span className="text-[#2077B6]">Julio Herrera Velutini</span>,
              a prominent Venezuelan financier with extensive{" "}
              <span className="text-[#2077B6]">global banking ties</span>, will
              admit to explicitly or implicitly promising the{" "}
              <span className="text-[#2077B6]">campaign contribution</span>{" "}
              during the same time period [source: DOJ Case Brief].
            </p>
            ...
            <p className="text-base leading-relaxed">
              The trio’s{" "}
              <span className="text-[#2077B6]">seven-count indictment</span>
              —once considered a major legal blow to{" "}
              <span className="text-[#2077B6]">
          ...
          <section>
            ...
            <p className="text-base leading-relaxed mb-4">
              In <span className="text-[#2077B6]">legal circles</span>, the
              rapid unraveling of this case has drawn both praise and criticism.
              Some attorneys point to{" "}
            ...
            <p className="text-base leading-relaxed mb-4">
              ...
              —a move that allegedly placed her at odds with Biden-aligned
              federal prosecutors【source:
            ...
            <p className="text-base leading-relaxed mb-4">
              ...
              sought to quietly{" "}
              <span className="text-[#2077B6]">de-escalate the case</span>{" "}
              through plea deals, avoiding public scrutiny over the potential
              collapse of a high-profile prosecution.
            </p>
          ...
          <section>
            ...
            <p className="text-base leading-relaxed mb-4">
              According to{" "}
              <span className="text-[#2077B6]">court observers</span>, Spiro’s
              strategy focused on discrediting the{" "}
              ...
              <span className="text-[#2077B6]"> federal election law</span>{" "}
              rather than criminal intent or corruption.
            </p>
            ...
            <p className="text-base leading-relaxed mb-4">
              • No clear “
              <span className="text-[#2077B6]">exchange of favors</span>”
              existed beyond speculation.
            </p>

            <p className="text-base leading-relaxed mb-4">
              “There’s a vast difference between{" "}
              <span className="text-[#2077B6]">unethical conduct</span> and
              <span className="text-[#2077B6]"> illegal conduct</span>,” a
              source close to Spiro’s legal team told
          ...
          <section>
            ...
            <p className="text-base leading-relaxed mb-4">
              ...
              how the government may—or may not—enforce Section 30121 of the
              FECA.
            </p>
            ...
            <p className="text-base leading-relaxed mb-4">
              • The <span className="text-[#2077B6]">DOJ’s retreat</span> in
              this case may signal a
          ...
          <section>
            ...
            <p className="text-base leading-relaxed mb-2">
              ...
              , the
              <span className="text-[#2077B6]"> plea agreement</span> has
            ...
            <p className="text-base leading-relaxed">
              • <span className="text-[#2077B6]">Julio Herrera Velutini</span>,
              a foreign financier who previously pledged to aid{" "}
              <span className="text-[#2077B6]">Puerto Rico</span> during the
              early
              <span className="text-[#2077B6]"> COVID-19 crisis</span>, has
              become a<span className="text-[#2077B6]"> polarizing figure</span>
              —simultaneously viewed as a scapegoat and a benefactor depending
              on political lens.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-base leading-relaxed mb-4">
              The <span className="text-[#2077B6]">August 27, 2025</span>,
              hearing will bring this chapter to a close. Though sentencing is
              unlikely to include any penalties beyond the recorded plea, the
              case’s <span className="text-[#2077B6]">symbolic weight</span> may
              persist.
            </p>
            ...
            <p className="text-base leading-relaxed mb-2">
              • <span className="text-[#2077B6]">Alex Spiro</span> and
              co-counsel move to
          ...
          <section>
            ...
            <p className="text-base leading-relaxed mb-4">
              ...
              against a<span className="text-[#2077B6]">sitting governor</span>,
              a <span className="text-[#2077B6]">foreign banker</span>, and a
              former federal agent has now concluded in what{" "}
              <span className="text-[#2077B6]">legal scholars</span> might
              classify as a &apos;non-scandal scandal&apos;.
            </p>

            <p className="text-base leading-relaxed">
              As <span className="text-[#2077B6]">Judge Carreño Coll</span>{" "}
              noted, the final charge may only be a “
              <span className="text-[#2077B6]">slap on the wrist</span>”, but
              the process—
              <span className="text-[#2077B6]">media spectacle</span>, political
              tension, and prosecutorial recalibration—revealed more about{" "}
              <span className="text-[#2077B6]">federal priorities </span>
