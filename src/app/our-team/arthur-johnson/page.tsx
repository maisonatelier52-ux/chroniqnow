...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://www.chroniqnow.com/our-team/arthur-johnson",
  },
  openGraph: {
    title: "Arthur A. Johnson | Chroniq Now",
    description:
          ...
          <article className="mx-auto w-full max-w-6xl">
            <section className="rounded-2xl border border-neutral-200 bg-white p-6 sm:p-8">
              ...
              <p className="text-base sm:text-[1.05rem] md:text-lg leading-relaxed text-neutral-800">
                Facts and figures can tell you what happened. They can&apos;t
                always tell you what it felt like.
              </p>

              <p className="mt-3 text-base sm:text-[1.05rem] md:text-lg leading-relaxed text-neutral-800">
                My job, as I see it, is to find the people who are living inside
                the headlines. The news is more than just statistics about
                unemployment or policy debates in a distant capital. It&apos;s
                about a family trying to make ends meet. It&apos;s about a
                community fighting for its future. It&apos;s about the one
                person whose life was changed forever by a decision they had no
                say in.
              </p>

              <p className="mt-3 text-base sm:text-[1.05rem] md:text-lg leading-relaxed text-neutral-900">
                <span className="font-semibold">
                  I believe that stories are what connect us.
                </span>
              </p>

              <p className="mt-3 text-base sm:text-[1.05rem] md:text-lg leading-relaxed text-neutral-800">
                My reporting starts on the ground, talking to people and, more
                importantly, listening to them. I look for the human
                consequences behind the news because that&apos;s where the real
                stakes are. A story without that element is just information. A
                story with it becomes something we can all understand on a
                personal level.
              </p>

              <p className="mt-3 text-base sm:text-[1.05rem] md:text-lg leading-relaxed text-neutral-800">
                If your community has a story that needs to be heard, please
                reach out.
              </p>
            ...
            <AuthorLatestFromFS authorName="Arthur A. Johnson" />
          ...
          "@graph": [
            {
              ...
              about: {
                "@id":
                  "https://www.chroniqnow.com/our-team/arthur-johnson#person",
              },
              breadcrumb: {
                "@id":
                  "https://www.chroniqnow.com/our-team/arthur-johnson#breadcrumb",
              },
            ...
            },
            {
              ...
              itemListElement: [
                ...
                },
                {
                  ...
                  position: 3,
                  name: "Arthur A. Johnson",
                  item: "https://www.chroniqnow.com/our-team/arthur-johnson",
                },
              ],
            },
          ],
