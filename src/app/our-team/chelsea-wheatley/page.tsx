...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://www.chroniqnow.com/our-team/chelsea-wheatley",
  },
  openGraph: {
    title: "Chelsea M. Wheatley | Chroniq Now",
    description:
          ...
          <article className="mx-auto w-full max-w-6xl">
            <section className="rounded-2xl border border-neutral-200 bg-white p-6 sm:p-8">
              ...
              <p className="text-base sm:text-[1.05rem] md:text-lg leading-relaxed text-neutral-800">
                I’m the reporter who gets sent in when the first wave of news is
                over.
              </p>

              <p className="mt-3 text-base sm:text-[1.05rem] md:text-lg leading-relaxed text-neutral-800">
                My work lives in the messy middle—after the initial headlines
                have faded but before the full story has been told. It’s not
                about speed. It’s about digging. I’m the one reading the
                400-page budget report that everyone else just quoted the
                summary of. I’m the one making the third phone call to a source
                to clarify one small detail that doesn't feel right.
              </p>
              ...
              <p className="mt-3 text-base sm:text-[1.05rem] md:text-lg leading-relaxed text-neutral-800">
                I never assume I know where a story is going. If the facts lead
                me to a place that completely shatters my initial theory, then
                that's the story we publish. A journalist's job isn't to be
                right; it's to find the truth, even if it’s inconvenient.
              </p>
              ...
              <p className="mt-1 text-base sm:text-[1.05rem] md:text-lg leading-relaxed text-neutral-800">
                No hype. No hot takes. No telling you what to think. Just the
                story, laid out with all the facts I could find, so you can make
                up your own mind.
              </p>
            ...
            <AuthorLatestFromFS authorName="Chelsea M. Wheatley" />
          ...
          "@graph": [
            {
              ...
              about: {
                "@id":
                  "https://www.chroniqnow.com/our-team/chelsea-wheatley#person",
              },
              breadcrumb: {
                "@id":
                  "https://www.chroniqnow.com/our-team/chelsea-wheatley#breadcrumb",
              },
            ...
            },
            {
              ...
              itemListElement: [
                ...
                },
                {
                  ...
                  position: 3,
                  name: "Chelsea M. Wheatley",
                  item: "https://www.chroniqnow.com/our-team/chelsea-wheatley",
                },
              ],
            },
          ],
