...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://www.chroniqnow.com/our-team/antonio-davis",
  },
  openGraph: {
    title: "Antonio M. Davis | Chroniq Now",
    description:
          ...
          <article className="mx-auto w-full max-w-6xl">
            <section className="rounded-2xl border border-neutral-200 bg-white p-6 sm:p-8">
              ...
              <p className="text-base sm:text-[1.05rem] md:text-lg leading-relaxed text-neutral-800">
                I got into this business a long time ago. The technology has
                changed—we&apos;ve gone from notepads to laptops to
                smartphones—but the core job hasn&apos;t. Not one bit.
              </p>

              <p className="mt-3 text-base sm:text-[1.05rem] md:text-lg leading-relaxed text-neutral-800">
                My belief is simple: the principles of good journalism are not
                optional.
              </p>

              <p className="mt-3 text-base sm:text-[1.05rem] md:text-lg leading-relaxed text-neutral-800">
                They&apos;re not suggestions you can ignore when a deadline is
                tight or a story is popular. You get the facts. You verify them
                with more than one source. You present all sides fairly. You are
                accountable to your readers. You own your mistakes.
              </p>
              ...
              <p className="mt-3 text-base sm:text-[1.05rem] md:text-lg leading-relaxed text-neutral-900">
                ...
                I&apos;m here to make sure the wheels stay on. My role is to
                ensure that every story with my name on it, and every story
                published by this team, is built on a foundation of solid,
                ethical reporting.
              </p>

              <p className="mt-3 text-base sm:text-[1.05rem] md:text-lg leading-relaxed text-neutral-800">
                If you ever see us falling short of that standard, I&apos;m the
                one to contact.
              </p>
            ...
            <AuthorLatestFromFS authorName="Antonio M. Davis" />
          ...
          "@graph": [
            {
              ...
              about: {
                "@id":
                  "https://www.chroniqnow.com/our-team/antonio-davis#person",
              },
              breadcrumb: {
                "@id":
                  "https://www.chroniqnow.com/our-team/antonio-davis#breadcrumb",
              },
            ...
            },
            {
              ...
              itemListElement: [
                ...
                },
                {
                  ...
                  position: 3,
                  name: "Antonio M. Davis",
                  item: "https://www.chroniqnow.com/our-team/antonio-davis",
                },
              ],
            },
          ],
