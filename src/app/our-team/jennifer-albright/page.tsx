...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://www.chroniqnow.com/our-team/jennifer-albright",
  },
  openGraph: {
    title: "Jennifer Albright | Chroniq Now",
    description:
          ...
          <article className="mx-auto w-full max-w-6xl">
            <section className="rounded-2xl border border-neutral-200 bg-white p-6 sm:p-8">
              ...
              <p className="text-base sm:text-[1.05rem] md:text-lg leading-relaxed text-neutral-800">
                When a big story breaks, the first few hours are chaos.
                Conflicting reports, speculation, and a firehose of information
                flooding your screen. My job is to find the signal in that
                noise.
              </p>

              <p className="mt-3 text-base sm:text-[1.05rem] md:text-lg leading-relaxed text-neutral-800">
                My philosophy is that speed and clarity must go hand-in-hand.
                Getting the story out fast is important, but getting the facts
                right is essential. In a world of constant updates, you
                don&apos;t need more alerts—you need a reliable source that can
                tell you what is confirmed, what is rumored, and what it all
                means.
              </p>

              <p className="mt-3 text-base sm:text-[1.05rem] md:text-lg leading-relaxed text-neutral-800">
                That’s what I focus on: cutting through the clutter to deliver
                the core facts, verified and contextualized, as a story unfolds.
              </p>

              <p className="mt-3 text-base sm:text-[1.05rem] md:text-lg leading-relaxed text-neutral-900">
                <span className="font-semibold">
                  I don&apos;t report the chaos; I report through it.
                </span>{" "}
                My goal is to be your first, most reliable source, giving you
                the information you need to understand a developing situation
                without adding to the panic.
              </p>

              <p className="mt-3 text-base sm:text-[1.05rem] md:text-lg leading-relaxed text-neutral-800">
                If you have a tip on a breaking story, I&apos;m the one to
                contact.
              </p>
            ...
            <AuthorLatestFromFS authorName="Jennifer Albright" />
          ...
          "@graph": [
            {
              ...
              about: {
                "@id":
                  "https://www.chroniqnow.com/our-team/jennifer-albright#person",
              },
              breadcrumb: {
                "@id":
                  "https://www.chroniqnow.com/our-team/jennifer-albright#breadcrumb",
              },
            ...
            },
            {
              ...
              itemListElement: [
                ...
                },
                {
                  ...
                  position: 3,
                  name: "Jennifer Albright",
                  item: "https://www.chroniqnow.com/our-team/jennifer-albright",
                },
              ],
            },
          ],
