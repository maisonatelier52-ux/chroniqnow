...
/**
 * Page Title EXACTLY as provided, using brand “Chroniq Now”
 * URL slug: /our-team/kenneth-butts
 */
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://www.chroniqnow.com/our-team/kenneth-butts" },
  openGraph: {
    title: "Kenneth M. Butts | Chroniq Now",
    description:
...
export default function AuthorKennethPage() {
  return (
    <>
      <div className="bg-white min-h-screen overflow-x-hidden">
        ...
        <main className="px-4 sm:px-6 lg:px-8">
          <article className="mx-auto w-full max-w-6xl">
            {/* About Kenneth (exact provided content, formatted) */}
            <section className="rounded-2xl border border-neutral-200 bg-white p-6 sm:p-8">
              ...
              <p className="text-base sm:text-[1.05rem] md:text-lg leading-relaxed text-neutral-800">
                I’ve always been more interested in the &quot;why&quot; than the &quot;what.&quot;
              </p>

              <p className="mt-3 text-base sm:text-[1.05rem] md:text-lg leading-relaxed text-neutral-800">
                Anyone can report that an event happened. That’s the easy part. But to me, the real job of a journalist is to explore the forces that led to that event. Was it a policy decision from five years ago? A social trend that’s been simmering under the surface? A technological shift that no one was paying attention to?
              </p>
              ...
              <p className="mt-3 text-base sm:text-[1.05rem] md:text-lg leading-relaxed text-neutral-900">
                <span className="font-semibold">I believe a story isn&apos;t a single point—it&apos;s a line.</span> It has a past, a present, and a future. My goal is to give you the whole line, not just the point that’s making noise today. If I can provide the context behind the headline, I’ve done my job.
              </p>

              <p className="mt-3 text-base sm:text-[1.05rem] md:text-lg leading-relaxed text-neutral-800">
                I'm always looking for patterns and stories that haven't been told yet. If you see a connection I'm missing or have a lead, my inbox is open.
              </p>
            ...
            <section aria-labelledby="latest-by-kenneth">
              <h2 id="latest-by-kenneth" className="text-2xl sm:text-3xl md:text-4xl font-bold tracking-tight">
                Latest by Kenneth
              </h2>
      ...
      <Script id="author-kenneth-jsonld" type="application/ld+json" strategy="afterInteractive">
        {JSON.stringify({
          ...
          "@graph": [
            {
              ...
              inLanguage: "en",
              about: { "@id": "https://www.chroniqnow.com/our-team/kenneth-butts#person" },
              breadcrumb: { "@id": "https://www.chroniqnow.com/our-team/kenneth-butts#breadcrumb" },
            ...
            {
              "@type": "BreadcrumbList",
              "@id": "https://www.chroniqnow.com/our-team/kenneth-butts#breadcrumb",
              itemListElement: [
                ...
                { "@type": "ListItem", position: 3, name: "Kenneth M. Butts", item: "https://www.chroniqnow.com/our-team/kenneth-butts" }
              ]
            }
          ]
        })}
